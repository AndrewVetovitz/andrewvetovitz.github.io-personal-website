...
export default function Page() {
  return (
    <>
      <Head>
        <meta name="description" content="About Page For Andrew Vetovitz describing his person" />
        <meta property="og:description" content="About Page For Andrew Vetovitz describing his person" />
      </Head>
      <div className="max-w-5xl mx-auto">
        <Title className="text-3xl pt-4">About</Title>
        <Text className="text-[18px] text-justify">
          Hi. My name is Andrew Vetovitz. I am a software engineer currently based in Cleveland, Ohio. I mainly have
