  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Resume Page For Andrew Vetovitz describing his work experience and downloadable copy of his resume"
        />
        <meta
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <List>
          ...
          <Li>
            Reduced product build times from 40+ minutes to 15 minutes through optimization and bottleneck analysis
          </Li>
        ...
        <List>
          ...
          <Li>
            Aided students in Software development (Java), Data Structures and Algorithms (C++), and Computer Systems
            (C)
          </Li>
